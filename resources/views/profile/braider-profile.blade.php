<x-layout>
    ...
    <div class="max-w-xl mx-auto pt-32 px-4 sm:px-6 lg:px-8">
        <a href="{{ route('profile.index') }}" class="inline-flex items-center text-tahini hover:underline mb-4">
            ← Back to Profile
        </a>

        <div class="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md">
            <h2 class="text-xl font-semibold text-tahini mb-4">Update your Braider Profile</h2>
